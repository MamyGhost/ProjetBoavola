...
<% 
     ...
     Float argentM=(Float)session.getAttribute("argentM");
     Float argentA=(Float)session.getAttribute("argentA");
      Float[][] statA=(Float[][])session.getAttribute("statA");
%>
<!DOCTYPE html>
<html>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><%= admin.getPseudo() %></span></a>
                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>Earnings (monsuel)</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span>$<%= argentM %></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Earnings (annuel)</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span>$<%= argentA %></span></div>
                                        </div>
